      ...
      <section className="neo-panel overflow-hidden p-6 sm:p-8">
        <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-end">
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-semibold uppercase tracking-[0.08em] sm:text-4xl">Vibecheck for Algorand trust intelligence</h1>
            ...
            <div className="flex flex-wrap gap-3">
              <Button asChild data-test-id="open-demo">
